...
|--------------|----------------------|
| Ubuntu 24.04/26.04 or Debian 12, PID1 systemd, ODS-managed local/cloud/hybrid/Lemonade route, separately authorized Pixel use | Pixel preferred; Hermes remains rollback |
...
- Pixel's conditional Ubuntu 24.04/26.04 or Debian 12 systemd qualification is an agent
